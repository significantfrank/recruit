	...
	<div class="addEdit-block" :style='{"padding":"30px"}'>
		...
		>
			<template >
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="select" v-if="type!='info'"  label="面试结果" prop="mianshijieguo">
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="面试结果" prop="mianshijieguo">
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="textarea" v-if="type!='info'" label="结果详情" prop="jieguoxiangqing">
					<el-input
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else-if="ruleForm.jieguoxiangqing" label="结果详情" prop="jieguoxiangqing">
					<span :style='{"fontSize":"14px","lineHeight":"40px","color":"#333","fontWeight":"500","display":"inline-block"}'>{{ruleForm.jieguoxiangqing}}</span>
				</el-form-item>
