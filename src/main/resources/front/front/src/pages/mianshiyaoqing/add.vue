...
<div :style='{"width":"100%","padding":"30px 7% 40px","margin":"0px auto","position":"relative","background":"none"}'>
    ...
    >
          ...
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}' label="邀请时间" prop="yaoqingshijian">
              <el-date-picker
          ...
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}' label="邀请内容" prop="yaoqingneirong">
            <el-input
              type="textarea"
              :rows="8"
              placeholder="邀请内容"
              v-model="ruleForm.yaoqingneirong">
            </el-input>
          </el-form-item>
      ...
      init(type) {
        ...
        if(type=='cross'){
          ...
          for (var o in obj){
            ...
            if(o=='yaoqingneirong'){
              this.ruleForm.yaoqingneirong = obj[o];
              this.ro.yaoqingneirong = true;
              continue;
            }
            if(o=='yaoqingshijian'){
